        ...
        <div class="box box-primary">
            <div class="box-header with-border no-padding-h-b">                            
                ...
                <div class="col-md-12 no-padding-h">
                    ...
                    <form action="{{route('maintain-items.purchaseDataStore',['stockid'=>$inventoryItem->id])}}" method="post" class="submitMe">
                        ...
                        <div class="row">
                                    ...
                                    <div class="col-sm-8">
                                        <select name="currency" class="form-control" id="currency">
                                            @foreach ($currencys as $currency)
                                                <option value="{{$currency->ISO4217}}">{{$currency->ISO4217}}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
                            ...
                            <div  style="margin-bottom:10px" class="col-md-12">
                                ...
                                <div class="col-sm-8">
                                  <input type="text" name="conversion_factor" id="conversion_factor" class="form-control" placeholder="Conversion Factor (to our UOM)" aria-describedby="helpId">
                                </div>
                            </div>
                            </div>
                            ...
                            <div  style="margin-bottom:10px" class="col-md-12">
                                ...
                                <div class="col-sm-8">
                                  <input type="number" name="min_order_qty" id="min_order_qty" class="form-control" placeholder="MinOrderQty" aria-describedby="helpId">
                                </div>
                                </div>
                            </div>
                            ...
                            <div  style="margin-bottom:10px" class="col-md-12">
                                ...
                                <div class="col-sm-8">
                                  <input type="text" name="lead_time" id="lead_time" class="form-control" placeholder="Lead Time (in days from date of order)" aria-describedby="helpId">
                                </div>
                                </div>
                            </div>--}}
                            <div  style="margin-bottom:10px" class="col-md-12">
