...
@section('content')
    <form id="purchaseForm" method="POST" action="{{ route($model . '.store') }}" accept-charset="UTF-8" class="addExpense"
        enctype="multipart/form-data">
        <input type="hidden" id="action" name="action" value="process">
        <input type="hidden" name="transport_rebate_discount_type" class="transport_rebate_discount_type">
        @csrf()
                        ...
                        <div class="col-sm-6">
                            <div class="form-group">
                                <div class = "row">
                                    ...
                                    <div class="col-sm-7">
                                        {!! Form::text('emp_name', auth()->user()->name, [
                                            'maxlength' => '255',
                                            'placeholder' => '',
                                            'class' => 'form-control',
                                            'readonly' => true,
                            ...
                            <div class="form-group">
                                <div class="row">
                                    ...
                                    <div class="col-sm-7">
                                        {!! Form::text('purchase_date', date('Y-m-d'), [
                                            'maxlength' => '255',
                                            'placeholder' => '',
                                            'class' => 'form-control',
                                            'readonly' => true,
                            ...
                            <div class="form-group">
                                <div class = "row">
                                    ...
                                    <div class="col-sm-7">
                                        <input type="checkbox" name="advance_payment" class="single_lpo_type"
                                            id="advance_payment">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class ="row">
                                ...
                                <div class="col-sm-7">
                                    <input type="checkbox" name="lpo_type" class="single_lpo_type lpo_type" value="Normal">
                                </div>
                            </div>
                        </div>
                        <div class="col-sm-6">
                            <div class="form-group">
                                <div class="row">
                                    ...
                                    <div class="col-sm-7">
                                        {!! Form::select('store_location_id', getStoreLocationDropdown(), null, [
                            ...
                            <div class="form-group">
                                <div class = "row">
                                    <div class="col-sm-7">
                                        ...
                                        <span id="show_supplier_own_error" style="color: red;font-weight:bolder">
...
">
    ...
    <script type="text/javascript">
        ...
        function load_supplier_discounts() {
            ...
            if (!store_location_id || store_location_id == "") {
                form.errorMessage('Please select store location');
                return false;
            }
            ...
            console.log(supplier_discounts);
        }
        ...
        @if(config('app.use_trade_agreements'))
        $('#wa_supplier_id, #store_location_id').change(function(e) {
